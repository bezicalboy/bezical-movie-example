...
@section('content')
    ...
    <div class="movie-info border-b border-gray-800">
        <div class="container mx-auto px-4 py-16 flex flex-col md:flex-row">
            <img src="{{ $movie['poster_path'] }}" alt="poster" class="w-64 md:w-96 object-scale-down">
            <div class="md:ml-24">
                ...
                <div class="mt-12">
                    <h4 class="text-white font-semibold">Feautured Crew</h4>
                    <div class="flex mt-4">
    ...
    {{-- end movie info --}}
    <div class="movie-cast border-b border-zinc-900">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-8">
                ...
                <div class="mt-8">
                    <a href="{{ route('actors.show', $cast['id'])}}">
                        ...
                        <img src="{{ 'https://image.tmdb.org/t/p/w300/'.$cast['profile_path'] }}" alt="profile" class="hover:opacity-75 transition ease-in-out duration-200 md:w-auto h-[400px]">
                        @else
                        <img src="{{ 'https://ui-avatars.com/api/?size=w300&name=' . $cast['name'] }}" alt="profile" class="hover:opacity-75 transition ease-in-out duration-200 md:w-auto h-[400px]">
                        @endif
                    </a>
                    <div class="mt-2">
